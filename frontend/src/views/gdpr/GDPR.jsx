    ...
    <>
      ...
      <div className="grid content about">
        <div className="main-content flex">
          ...
          <h2>Datenerfassung auf dieser Webiste</h2>
          <p>
            <strong>
          ...
          <p>
            Wir setzen folgenden Hoster ein: Vultr Holdings Corporation 319
            Clematis Street Suite 900 West Palm Beach, USA FL 33401
          </p>
          ...
          <p>
            ...
            <br />
            <br />
            Telefon: +49 (0) 176 61506705
            <br />
            E-Mail: marc@buchardtprivat.de
          </p>
          <p>
          ...
          <p>
            <strong>
              Beschwerderecht bei der zuständingen Aufsichtsbehörde
            </strong>
          </p>
          <p>
